# Kira IDE Integration Guide for Development Standards

## Overview

This guide shows how to integrate our development standards with Kira IDE's spec-driven development workflow. Kira IDE uses specifications to guide AI code generation, and our standards serve as the specification foundation.

---

## Understanding Kira IDE + Our Standards

### How Kira IDE Works
1. You write a **specification** describing what you want
2. Kira IDE's AI generates code based on the spec
3. Code is validated against patterns and standards
4. Iterative refinement until requirements are met

### Our Standards as Kira Specifications
...
## Document Structure for Kira IDE

### Primary Specifications (Always Active)

These should be loaded into Kira's context for every session:
...
## Kira IDE Workflow Integration

### 1. Project Setup Phase

**Specification to Provide Kira:**
...
**Specification Template for Kira:**
...
**Specification for Kira IDE Code Review:**
...
## Kira IDE Context Files

### Create `.kira/` Directory
...
└── config.yaml                            # Kira configuration
```

### Kira Configuration File
...
## Quick Reference Card for Kira

Save this as `.kira/quick-reference.md`:

```markdown
# Kira IDE Quick Reference
...
### Code Review
@kira review --spec=code-review.md
...
```markdown
# Kira Session: Implement Market Trading Feature

## Session Setup
@kira start --load-defaults
@specs/domain/errors.md
@specs/workflows/race-conditions.md

## Step 1: Generate Service
@kira create service --name=MarketTradingService
...
@kira review --file=market-trading.service.ts
...
[Kira identifies issues]

## Step 3: Fix Issues
@kira fix --issues=[list from review]

[Kira applies fixes]

## Step 4: Add Tests
@kira generate tests --file=market-trading.service.ts
...
[Kira generates tests]

## Step 5: Final Validation
@kira validate --strict
...
[Kira confirms all pass]

## Step 6: Generate Documentation
@kira document --file=market-trading.service.ts
...
## Summary: Kira IDE + Standards Integration
...
❌ **DON'T:**
- Assume Kira knows standards without loading them
...
**Remember**: Kira IDE is most effective when given clear specifications. Your standards documents ARE those specifications. Load them, reference them, validate against them.