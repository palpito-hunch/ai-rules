...
gh repo create org/new-project --template org/backend-template --private --clone
...
Available templates:
- `palpito-hunch/backend-template` - Node.js + Express + Prisma backend
- `palpito-hunch/frontend-template` - Next.js + React + Tailwind frontend
